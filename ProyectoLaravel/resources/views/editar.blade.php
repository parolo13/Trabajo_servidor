...
<input type="text" name="name" id="name" placeholder="Pablo Rodriguez" value="{{ old('name', $user->name) }}">
<br>
<label for="email">Email</label>
<input type="email" name="email" id="email" placeholder="ejemplo@ejemplo.com" value="{{ old('email', $user->email) }}">
<br>    
